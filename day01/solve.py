...
processed_lines_day_1 = map(process_line_day_1, get_file_lines("./day01/input.txt"))
processed_lines_day_2 = map(process_line_day_2, get_file_lines("./day01/input.txt"))
